...
namespace ITICH
{
    public partial class PesquisarParques : Form
    {
        ...
        {
            string pesquisaNome = "SELECT P.nome_parque, L.distrit, P.e_mail FROM Parques_cientificos P, Localizacao L " +
                "WHERE P.nome_parque ='" + textBox_pesquisa.Text + "' AND L.id_localizacao = P.id_localizacao";

            string pesquisaDistrito = "SELECT P.nome_parque, L.distrit, P.e_mail FROM Parques_cientificos P, Localizacao L " +
                "WHERE L.distrit ='" + textBox_pesqDistrito.Text + "' AND L.id_localizacao = P.id_localizacao";

            string pesquisaNomeDistrito = "SELECT P.nome_parque, L.distrit, P.e_mail FROM Parques_cientificos P, Localizacao L " +
                "WHERE P.nome_parque ='" + textBox_pesquisa.Text + "'AND L.distrit ='" + textBox_pesqDistrito.Text + "' " +
                "AND L.id_localizacao = P.id_localizacao";
